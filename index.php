...
<!-- ------------------------------------------------------------------------ -->
						...
						<div class='landing-tx1-heading pulsate'>
							<h1 style='font-size: 170%'>Enaсtus<br>
							 Нан үчүн гана</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p style="font-size: 120%">
							Первый в Кыргызстане проект сбора и использования ненужного хлеба в корм.
							</p>
					...
					<div class="patreon-con-mantra">
						...
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
								Вы можете поддержать устойчивое развитие нашей страны, а так же проектов Enactus KEU, пожжертвовав на Patreon
								</p>
							</div>
